...
const ACTIVITY_CATEGORY_DEFINITIONS = [
  ...
  [DemoEventCategoryId.JEWELRY, '珠宝', ['珠宝设计与当代收藏', '宝石色彩与佩戴美学', '独立设计地图导览'], '以设计、材料与佩戴方式为线索，呈现细致的观看与交流。', ['/assets/editorial-events/jewelry-study.jpg', '珠宝展柜视觉参考', 'Hannolans · CC BY 4.0']],
