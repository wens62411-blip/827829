...
export const DEMO_ART_CREATORS:readonly ArtCreator[]=[
  creator('creator_demo_lin','林墨（虚构演示）','合成人物，不代表真实艺术家或签约关系。','ARTIST',CityId.CN_SHENZHEN),
