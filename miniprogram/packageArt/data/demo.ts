...
export const DEMO_ART_CONTENT:readonly ArtContentDetail[]=[
  {...common,contentId:'content_demo_art_ink_001' as ContentId,collectionId:'collection_demo_art_editorial' as CollectionId,creatorId:'creator_demo_lin' as StableId<'creator'>,creatorDisplayName:'林墨（非真实人物）',title:'潮汐之后 / After the Tide',summary:'合成艺术记录，用于预览人物、作品与同城活动的关联。',category:'ART',cityId:CityId.CN_HANGZHOU,sourceTitle:'AB Club 合成艺术资料',sourceUrl:'https://example.invalid/ab-club/art-demo/art-001',alt:'合成艺术记录未配置作品图片',artwork:{author:'林墨（非真实人物）',workTitle:'潮汐之后（合成示例）',year:'2026（合成示例）',medium:'纸本综合媒介（合成示例）',dimensions:'78 × 112 cm（合成示例）',edition:'单件合成示例',exhibitionHistory:'无；不对应真实展览记录。',provenanceInformation:'本地合成资料，无真实持有人或来源链。'}},
  {...common,contentId:'content_demo_antique_vessel_001' as ContentId,collectionId:'collection_demo_antique_notes' as CollectionId,creatorId:'creator_demo_research_desk' as StableId<'creator'>,creatorDisplayName:'器物资料组（非真实机构）',title:'器物笔记：年代与来源待核对',summary:'合成古董资料，只预览年代、来源与状况字段，不构成鉴定。',category:'ANTIQUE',cityId:CityId.CN_SHANGHAI,sourceTitle:'AB Club 合成器物资料',sourceUrl:'https://example.invalid/ab-club/art-demo/antique-001',alt:'合成古董记录未配置器物图片',antique:{periodRange:'20 世纪上半叶（合成示例）',objectType:'陈设器物（合成示例）',knownProvenance:'无真实来源链。',conditionStatement:'无实物检查，仅用于预览状况字段。',thirdPartyReportReference:'本机示例编号；非真实报告。'}},
  {...common,contentId:'content_demo_jewelry_pearl_001' as ContentId,collectionId:'collection_demo_jewelry_materials' as CollectionId,creatorId:'creator_demo_material_lab' as StableId<'creator'>,creatorDisplayName:'材质档案室（非真实机构）',title:'海水珍珠项饰材质记录',summary:'合成珠宝记录，不对应商品、库存、签约或投资标的。',category:'JEWELRY',cityId:CityId.FR_PARIS,sourceTitle:'AB Club 合成珠宝资料',sourceUrl:'https://example.invalid/ab-club/art-demo/jewelry-001',alt:'合成珍珠珠宝记录未配置首饰图片',jewelry:{jewelryKind:'PEARL',materialStatement:'白色金属与海水珍珠均为合成示例声明。',gemstoneOrPearlInformation:'合成示例珠径 7.5–8.0 mm；无真实分级。',dimensions:'合成示例链长 420 mm',reportReference:'本机示例编号；非真实报告。',displayAuthorization:'未配置图片展示授权。'}},
] as const;
...
export const DEMO_ART_CREATORS:readonly ArtCreator[]=[
  creator('creator_demo_lin','林墨（非真实人物）','合成人物，不代表真实艺术家或签约关系。','ARTIST',CityId.CN_HANGZHOU),
  creator('creator_demo_research_desk','器物资料组（非真实机构）','合成资料角色，不代表鉴定机构。','INSTITUTION',CityId.CN_SHANGHAI),
  creator('creator_demo_material_lab','材质档案室（非真实机构）','合成资料角色，不代表检测实验室。','INSTITUTION',CityId.FR_PARIS),
];
