...
__export(idempotency_exports, {
  assertIdempotencyCompatible: () => assertIdempotencyCompatible,
  createIdempotencyClaim: () => createIdempotencyClaim,
...
function fingerprintPayload(payload) {
  return (0, import_node_crypto.createHash)("sha256").update(canonicalize(payload), "utf8").digest("hex");
}
